...
class FormSingleChoiceQuizzComponent extends React.Component {
  ...
  setValue(e) {
    if (e.target.id === 'single_choice_quizz_description_md') {
    ...
    } else if (e.target.id === 'single_choice_quizz_success_message_md') {
  ...
  render() {
    ...
    let description_md_input_name = "single_choice_quizz[description_md]";
    let description_md_input_id = "single_choice_quizz_description_md";
    let description_md_form_group_class = "form-group";
    let description_md_input_class = "single_choice_quizz_description_md form-control";
    let description_md_input_value = this.props.element ? this.props.element.attributes.descriptionMd : null ;
    let description_html_input_name = "single_choice_quizz[description_html]";
    ...
    let success_message_md_input_name = "single_choice_quizz[success_message_md]";
    let success_message_md_input_id = "single_choice_quizz_success_message_md";
    let success_message_md_form_group_class = "form-group";
    let success_message_md_input_class = "single_choice_quizz_success_message_md form-control";
    let success_message_md_input_value = this.props.element ? this.props.element.attributes.successMessageMd : null ;
    let success_message_html_input_name = "single_choice_quizz[success_message_html]";
    ...
    let buttonText = (this.props.element ? 'Update quizz' : 'Add quizz') + ' (single choice)';
    const titleText = this.props.element ? 'Edit “' + this.props.element.attributes.fullTitle + '”' : 'Add quizz (single choice)';
      ...
      <div className='panel panel--form'>
        ...
        <form onChange={ this.setValue } onSubmit={ this.submitForm } className='form-vertical form-full-width'>
          ...
          <FormAnswersComponent
            objectType='single_choice_quizz'
...
export default FormSingleChoiceQuizzComponent;
